  ...
  return (
    <section id="contact" className="max-w-[1200px] mx-auto my-20 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-slate-600 text-sm md:text-base mt-2 max-w-lg mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="light-card p-8 rounded-2xl border border-slate-200 flex flex-col justify-between h-full">
          <div>
            ...
            <h3 className="text-2xl font-display font-bold text-[#0A192F] mb-3">
          ...
          <div className="mt-8 pt-6 border-t border-slate-200 space-y-3 text-sm text-slate-700">
            <div className="flex items-center gap-3">
              ...
              <span>stivensena2017@gmail.com</span>
            </div>
            <div className="flex items-center gap-3">
              <FaMapMarkerAlt className="text-[#00A797] text-base" />
              <span>Bogotá D.C., Colombia (Remoto / Presencial)</span>
            </div>
