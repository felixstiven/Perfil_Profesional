  ...
  return (
    <div className="xl:w-[25%] lg:w-[30%] border border-lightBrown p-4 rounded-xl">
      <p className="text-lg text-center text-lightGrey">
        ...
        solutions. <br />
        My experience includes working on various projects,
        from small websites implementing back-end logic to creating APIs.{" "}
        <span className="font-bold text-white">small front-end and bac-kend systems</span>,
