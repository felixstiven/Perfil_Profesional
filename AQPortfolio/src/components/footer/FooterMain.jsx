...
const FooterMain = () => {
  ...
  return (
    <footer className="border-t border-slate-200 bg-white py-12 px-4 mt-20 shadow-sm">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        <div>
          <h3 className="text-xl font-display font-bold text-[#0A192F] flex items-center gap-2">
        ...
        <ul className="flex flex-wrap justify-center gap-6 text-sm text-slate-600">
        ...
        <div className="flex gap-4">
          <a
            ...
            className="w-9 h-9 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-[#0A192F] hover:bg-[#0A192F] hover:text-white transition-all cursor-pointer"
          >
            <FaLinkedinIn />
          </a>
          <a
      ...
      <div className="max-w-[1200px] mx-auto text-center mt-8 pt-6 border-t border-slate-100 text-xs text-slate-400">
