...
const NavbarMain = () => {
  ...
  return (
    <nav className="max-w-[1200px] mx-auto w-full px-4 fixed left-[50%] -translate-x-[50%] z-50 mt-4">
      ...
      <div className="flex justify-between items-center w-full bg-white/95 backdrop-blur-md px-4 md:px-6 py-2.5 md:py-3.5 rounded-full border border-slate-200 shadow-md">
        {/* Logo a la Izquierda */}
        <NavbarLogo />
